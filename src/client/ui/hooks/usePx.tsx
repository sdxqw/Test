...
/**
 * @see {@link https://discord.com/channels/476080952636997633/476080952636997635/1146857136358432900}
 */
function calculateScale(viewport: Vector2) {
	const width = math.log(viewport.X / BASE_RESOLUTION.X) / math.log(2);
	const height = math.log(viewport.Y / BASE_RESOLUTION.Y) / math.log(2);
